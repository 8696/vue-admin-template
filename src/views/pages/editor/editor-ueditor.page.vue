...
<script>
  ...
  export default {
    ...
    async mounted() {
      await asyncLoadScript().js('https://public-file-020.oss-cn-guangzhou.aliyuncs.com/ueditor/utf8-php/ueditor.config.js');
      await asyncLoadScript().js('https://public-file-020.oss-cn-guangzhou.aliyuncs.com/ueditor/utf8-php/ueditor.all.min.js');
      await asyncLoadScript().js('https://public-file-020.oss-cn-guangzhou.aliyuncs.com/ueditor/utf8-php/lang/zh-cn/zh-cn.js');
